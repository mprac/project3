# Generated by Django 2.0.3 on 2020-05-03 16:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(verbose_name=datetime.datetime(2020, 5, 3, 16, 17, 42, 737114, tzinfo=utc))),
        ...
        migrations.AddField(
            model_name='menuitem',
            name='style',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='styles', to='orders.Style'),
        ),
        migrations.AddField(
            model_name='cart',
            name='orders',
